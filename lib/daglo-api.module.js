...
import { AudioClassifier, FilesetResolver } from "https://cdn.jsdelivr.net/gh/actionpower/dagloapi-js-beta@refs/heads/main/lib/mediapipe-audio.module.js";
      ...
      let lib = {
        ...
        init: async () => {
          ...
          lib.model.audio = await FilesetResolver.forAudioTasks(
            'https://cdn.jsdelivr.net/gh/actionpower/dagloapi-js-beta@refs/heads/main/lib/wasm'
          );
          lib.model.audioClassifier = await AudioClassifier.createFromOptions(lib.model.audio, {
            baseOptions: {
              modelAssetPath: 'https://cdn.jsdelivr.net/gh/actionpower/dagloapi-js-beta@refs/heads/main/lib/audio.tflite'
            }
          })
